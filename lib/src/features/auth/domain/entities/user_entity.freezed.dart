...
abstract class $UserEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String userName, String aboutUser});
}
...
class _$_UserEntity implements _UserEntity {
  _$_UserEntity(
      {required this.id, required this.userName, required this.aboutUser});
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, userName: $userName, aboutUser: $aboutUser)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, userName, aboutUser);
...
abstract class _UserEntity implements UserEntity {
  factory _UserEntity(
      ...
      required final String aboutUser}) = _$_UserEntity;
